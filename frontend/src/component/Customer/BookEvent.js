                                        ...
                                        <table className="col-12">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select className="form-select" aria-label="Default select example" onChange={(e) => { settype(e.target.value) }}>
                                                            ...
                                                            <option value="COLLAGE_EVENT">COLLEGE EVENT</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="date" className="my-2" value={date} placeholder="Enter Event Date" onChange={(e) => { setdate(e.target.value) }} /></td>                                                </tr>
