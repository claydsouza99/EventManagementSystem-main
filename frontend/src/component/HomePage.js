  ...
  return (
    <div className="d-block">
      ...
      >
        ...
        <div className="carousel-inner">
          <div className="carousel-item active" data-bs-interval="5000">
            <img //carousel-inner are each images on the slides
              src={img1}
      ...
      <div className="container position-absolute top-50 start-50 translate-middle text-black">
        <h1 className="display-1 fw-bold">{state.title}</h1>                            
        <p className="display-5 px-5">{state.text}</p>
        <div className=" d-grid col-6  mx-auto my-4">
          <Link 
            className="btn bg-black text-white btn-lg my-3 py-3 px-5 border-danger border-4 rounded-pill opacity-75 fs-4"
            to={"/customer"}
            role="button"
          >
            Customer
